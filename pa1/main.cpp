...
enum menu_options_t {REMOVE_RED = 1, REMOVE_BLUE, REMOVE_GREEN, NEGATE_RED, NEGATE_BLUE, NEGATE_GREEN, ADD_RANDOM_NOISE, HIGH_CONTRAST, GRAY_SCALE, FLIP_VERTICAL, FLIP_HORIZONTAL, ROTATE, BLUR_EFFECT}; //PA1 TODO: fill in the rest
...
menu_options_t getMenuSelection()
{
    ...
    vector<string> menu_options{ " " ,"Remove red", "Remove blue", "Remove green", "Negate red", "Negate blue", "Negate green", "Add Random Noise", "High Contrast", "Gray Scale", "Flip Vertical", "Flip Horizontal", "Rotate", "Blur Effect"};
...
void applyImageEffect(PpmDocument &doc, menu_options_t option)
{
    ...
    case CHAINING_EFFECTS:
        effect = new ChainingEffects();
        break;
